...
const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-300" >
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-64 bg-card border-r border-border transform transition-transform duration-200 ease-in-out dark:bg-[#13161B]",
          {
      ...
      >
        <header  className="h-16 bg-card border-b border-border flex items-center justify-between px-4 dark:bg-[#13161B]">
